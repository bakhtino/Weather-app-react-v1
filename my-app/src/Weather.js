    ...
    <div className="container">
      <div className="weather-app">
        <form id="search-form" className="mb-3">
          <div className="row">
            <div className="col-9">
              <input type="search" placeholder="Type city name.." className="form-control" id="city-input" autocomplete="off"/>
            </div>
            <div className="col-3">
        ...
        <ul>
          <li>Last updated: <span id="date">Friday 23:48 </span></li>
          <li id="description" className="description">few clouds</li>
        </ul>
        <div className="row">
          <div className="col-6">
            <div className="clearfix weather-temperature">
              <img src=" http://openweathermap.org/img/wn/02n@2x.png" alt="few clouds" className="float-left" id="icon"/>

              <strong id="temperature">34</strong>
          ...
          <div className="col-6">
            <ul>
              ...
              <li>Wind : <span id="wind">4</span>Km/h</li>
            </ul>
          </div>
        </div>
        <div className="weather-forecast" id="forecast"><div class="row"><div className="col-2">
